...
class AzureClient(OpenAIClient):
    def get_byok_overrides(self, llm_config: LLMConfig) -> Tuple[str | None, str | None, str | None]:
    ...
    async def get_byok_overrides_async(self, llm_config: LLMConfig) -> Tuple[str | None, str | None, str | None]:
        # Memos: All providers are BYOK, always get credentials from provider
        from letta.services.provider_manager import ProviderManager
